...
UReplicatedVRSimpleCameraComponent::UReplicatedVRSimpleCameraComponent(const FObjectInitializer& ObjectInitializer)
...
//=============================================================================
void UReplicatedVRSimpleCameraComponent::GetLifetimeReplicatedProps(TArray< class FLifetimeProperty > & OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION(UReplicatedVRSimpleCameraComponent, ReplicatedTransform, COND_SkipOwner);
	DOREPLIFETIME(UReplicatedVRSimpleCameraComponent, NetUpdateRate);
	//DOREPLIFETIME(UReplicatedVRSimpleCameraComponent, bReplicateTransform);
}

void UReplicatedVRSimpleCameraComponent::Server_SendTransform_Implementation(FBPVRComponentPosRep NewTransform)
{
...
bool UReplicatedVRSimpleCameraComponent::Server_SendTransform_Validate(FBPVRComponentPosRep NewTransform)
{
	return true;
	// Optionally check to make sure that player is inside of their bounds and deny it if they aren't?
}

void UReplicatedVRSimpleCameraComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
...
void UReplicatedVRSimpleCameraComponent::GetCameraView(float DeltaTime, FMinimalViewInfo& DesiredView)
{
